...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference("Dish.count") do
      post dishes_url, params: { dish: { ingredient_id: @dish.ingredient_id, name: @dish.name } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { ingredient_id: @dish.ingredient_id, name: @dish.name } }
